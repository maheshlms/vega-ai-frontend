    ...
    const IdentityProviderSetting = () => {
        ...
        const [notConnectedProviders, setNotConnectedProviders] = useState([
            {
                id: 3,
                icon: "SA",
                title: "SAML/OIDC",
        ...
        const [modalMode, setModalMode] = useState(''); // 'configure' or 'connect'
        ...
        const confirmDisconnect = () => {
            ...
            setNotConnectedProviders(prev => [...prev, { ...providerToDisconnect, status: "Not Connected", config: null }]);
