...
const UserGroupSetting: React.FC = () => {
    ...
    const [defaultRole, setDefaultRole] = useState<string>('Standard User');
    const [defaultGroups, setDefaultGroups] = useState<string>('All Users');
    const [emailVerificationRequired, setEmailVerificationRequired] = useState<boolean>(true);
    ...
    const [groupSyncEnabled, setGroupSyncEnabled] = useState<boolean>(true);
    const [syncSource, setSyncSource] = useState<string>('Azure AD');
    const [syncFrequency, setSyncFrequency] = useState<string>('Every 6 hours');
    ...
    const [selfServiceOptions, setSelfServiceOptions] = useState<SelfServiceOptions>({
        updateProfile: true,
        resetPassword: true,
        requestAccess: false,
        createGroups: false
    ...
    // Modal States
    const [showAddMappingModal, setShowAddMappingModal] = useState<boolean>(false);
    ...
    const [newMapping, setNewMapping] = useState<NewMapping>({ sourceGroup: '', vegaGroup: '' });
    const [newRole, setNewRole] = useState<NewRole>({ name: '', icon: '👤', users: 0, color: 'blue' });

    // Handle Self-Service Option Change
    const handleSelfServiceChange = (option: keyof SelfServiceOptions): void => {
    ...
    const handleRemoveMapping = (id: number): void => {
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6 shadow-md hover:shadow-lg transition-all duration-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <select
                                    value={defaultRole}
                                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setDefaultRole(e.target.value)}
                            ...
                            <div>
                                ...
                                <select
                                    value={defaultGroups}
                                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setDefaultGroups(e.target.value)}
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                >
                        ...
                        <div className="space-y-3 mb-6">
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEmailVerificationRequired(e.target.checked)}
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSendWelcomeEmail(e.target.checked)}
                                    className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 cursor-pointer"
                                />
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setRequireAdminApproval(e.target.checked)}
                                    className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 cursor-pointer"
                                />
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6 shadow-md hover:shadow-lg transition-all duration-300">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setGroupSyncEnabled(e.target.checked)}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <select
                                    value={syncSource}
                                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setSyncSource(e.target.value)}
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                >
                            ...
                            <div>
                                ...
                                <select
                                    value={syncFrequency}
                                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setSyncFrequency(e.target.value)}
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                >
                        ...
                        <div className="p-6 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewMapping({ ...newMapping, sourceGroup: e.target.value })}
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewMapping({ ...newMapping, vegaGroup: e.target.value })}
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full animate-scale-in">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <select
                                    value={newRole.icon}
                                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setNewRole({ ...newRole, icon: e.target.value })}
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
                                >
                            ...
                            <div>
                                ...
                                <select
                                    value={newRole.color}
                                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setNewRole({ ...newRole, color: e.target.value })}
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
                                >
