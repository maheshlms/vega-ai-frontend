...
type Timezone = 'UTC-8 (PST)' | 'UTC-5 (EST)' | 'UTC+0 (GMT)' | 'UTC+1 (CET)' | 'UTC+5:30 (IST)' | 'UTC+8 (CST)';
...
type FirstDayOfWeek = 'Sunday' | 'Monday' | 'Saturday';
...
const GeneralSetting: React.FC = () => {
    ...
    const [organizationName, setOrganizationName] = useState<string>('Vega AI Corp');
    const [displayName, setDisplayName] = useState<string>('Vega.ai');
    const [website, setWebsite] = useState<string>('https://vega.ai');
    const [supportEmail, setSupportEmail] = useState<string>('support@vega.ai');
    const [organizationLogo, setOrganizationLogo] = useState<string | null>(null);

    // Regional Settings States
    const [timezone, setTimezone] = useState<Timezone>('UTC-8 (PST)');
    ...
    const [customDomain, setCustomDomain] = useState<string>('app.vega.ai');
    const [enableCustomDomain, setEnableCustomDomain] = useState<boolean>(true);

    // Data Management States
    const [lastBackup, setLastBackup] = useState<string>('January 20, 2026');
    ...
    const [showSystemNotifications, setShowSystemNotifications] = useState<boolean>(true);
    ...
    const handleBackupSettings = (): void => {
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full animate-scale-in">
                        ...
                        <div className="p-6">
                            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                                ...
                                <label
                                    htmlFor="logo-upload"
                                    className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium cursor-pointer inline-block transition-all duration-200"
                                >
                                    Choose File
                                </label>
