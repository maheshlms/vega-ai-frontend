...
const AuditLogsSetting = () => {
    ...
    const [currentStorage, setCurrentStorage] = useState({ used: 2.4, total: 10 });
    const [autoArchive, setAutoArchive] = useState(true);
    const [compressArchived, setCompressArchived] = useState(true);
    const [archiveLocation, setArchiveLocation] = useState('AWS S3');
    ...
    const [automatedReports, setAutomatedReports] = useState(true);
    const [reportType, setReportType] = useState('SOC 2');
    const [reportFrequency, setReportFrequency] = useState('Monthly');
    const [reportRecipients, setReportRecipients] = useState('admin@vega.ai');

    // Access Logs States
    const [logAllAccess, setLogAllAccess] = useState(true);
    const [includeIPAddresses, setIncludeIPAddresses] = useState(true);
    ...
    const handleLogCategoryChange = (category) => {
