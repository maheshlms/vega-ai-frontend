...
const SecuritySetting = () => {
    ...
    const [twoFactorRequirements, setTwoFactorRequirements] = useState({
    ...
    const handleTwoFactorRequirementChange = (requirement) => {
    ...
    const handleSessionSettingChange = (setting) => {
                        ...
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    ...
                                    onChange={(e) => setIpWhitelistingEnabled(e.target.checked)}
                            ...
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input
                                        ...
                                        onChange={(e) => setIpBlockingEnabled(e.target.checked)}
                                        className="sr-only peer"
                                    />
                                    <div className="w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                </label>
                        ...
                        <div className="space-y-2">
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <input
                                    ...
                                    onChange={(e) => setLogAPIRequests(e.target.checked)}
                                    className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 cursor-pointer"
                                />
