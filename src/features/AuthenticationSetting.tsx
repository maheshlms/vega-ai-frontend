...
const AuthenticationSetting: React.FC = () => {
    ...
    const [passwordExpiration, setPasswordExpiration] = useState<string>("90");
    const [timeoutDuration, setTimeoutDuration] = useState<string>("30");
