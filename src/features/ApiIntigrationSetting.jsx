...
const  ApiIntegrationSetting = () => {
    ...
    const [currentUsage, setCurrentUsage] = useState({ used: 247, total: 1000 });
                ...
                <div className="bg-white border-b border-gray-200">
                    <div className="flex items-center gap-3 p-6 cursor-pointer">
                        ...
                        <div>
                            ...
                            {/* <p className="text-xs text-gray-600">Manage API keys, webhooks, and connected applications</p> */}
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full animate-scale-in">
                        ...
                        <div className="p-6">
                            <p className="text-gray-700 leading-relaxed">
                                Are you sureyou want to regenerate <strong>{selectedKey?.name}</strong>?
<br /><br />
The old key will stop working immediately, and any applications using it will need to be updated.
</p>
</div><div className="flex gap-3 p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
                        <button
