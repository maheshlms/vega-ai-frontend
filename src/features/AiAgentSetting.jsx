...
const AiAgentsSetting = () => {
    ...
    const [defaultAgent, setDefaultAgent] = useState('Orion');
    ...
    const [autoCompleteQueries, setAutoCompleteQueries] = useState(true);
    ...
    const [requireMFAForExpertMode, setRequireMFAForExpertMode] = useState(false);

    // Default Behaviors States
    const [confirmDestructiveActions, setConfirmDestructiveActions] = useState(true);
    const [logAllActivities, setLogAllActivities] = useState(true);
    const [showConfidenceScores, setShowConfidenceScores] = useState(true);
    const [enableAutoExecution, setEnableAutoExecution] = useState(false);
